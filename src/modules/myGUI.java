...
public class MyGUI extends JFrame {
  ...
  private JRadioButton posPolarRadioBtn;
  
  private JRadioButton negPolarRadioBtn;
  
  private JTextField lowRange;
  
  private JTextField highRange;
  
  private JTextField searchTol;
  
  private JRadioButton ppmRadioBtn;
  
  private JRadioButton mzRadioBtn;
  
  private JTextField searchIntensThresh;
  
  private JRadioButton countsRadioBtn;
  
  private JRadioButton relResRadioBtn;
  
  private JRadioButton monoRadioBtn;
  
  private JRadioButton avgRadioBtn;
